  ...
  return (
    <div className="flex items-center">
      <input
        ...
        checked={checked}
        onChange={onChange}
        className="h-5 w-5 rounded-md border-2 border-white/80 bg-transparent appearance-none checked:bg-none
      ...
      />
      <label htmlFor={id} className="ml-3 text-base text-white/90 font-['Segoe_UI']">
        {label}
      </label>
    </div>
  )
